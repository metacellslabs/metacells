...
export const HELP_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      '`/tg hello` or `/tg:send:hello` sends a Telegram message from a cell once on commit',
      '`/x hello` or `/x:send:hello` publishes a text post to the configured Twitter/X account',
